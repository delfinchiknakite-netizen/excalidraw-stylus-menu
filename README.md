...
- **Фигура**: добавить текст, **стрелка к объекту…** (затем тапните целевой объект — стрелка
  свяжет оба), стикер на объект, дублировать, удалить.
- **Стрелка/линия**: добавить текст, **наконечники** (в конце / с обеих сторон / в начале /
