...
**Тап пером по выделенным объектам** → меню действий над всем выделением: **дублировать** и
**удалить** (со всеми связями и подписями). Сначала выделите объекты (рамкой/по одному), затем
тапните по ним. Имеет приоритет над меню одиночной фигуры.
