...
**Тап пером по объекту** (касание без движения) → всплывающее меню действий над объектом: добавить
текст, стрелка от объекта, стикер на объект, дублировать, удалить. Отключается в настройках
(«Меню действий по тапу на объект»). Тап по пустому месту не затрагивается.
