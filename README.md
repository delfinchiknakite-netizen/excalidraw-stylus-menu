...
По умолчанию — **боковая кнопка S Pen при парении** (жест `penbutton`): наведите перо над холстом
**без касания** и нажмите-отпустите боковую кнопку → меню вставки в позиции пера (у края блока —
стрелка-коннектор).
